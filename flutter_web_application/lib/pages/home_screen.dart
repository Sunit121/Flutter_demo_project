...
import 'package:flutter_web_application/models/my_product.dart';
import 'package:flutter_web_application/pages/details_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _buildSneakars() => GridView.builder(
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 2,
          childAspectRatio: (100 / 140),
          crossAxisSpacing: 12,
